      ...
      <React.Fragment>
        ...
        <div className="Home-Body">
            ...
            <div className="container">
              <div className="row">
                <div className=" col-12 col-md-6">
                  <img width="100%" src={Images.image_home_img1}/> 
                </div>
                <div className=" col-12 col-md-6 ">
          ...
          <div className="Home-Content-Download">
            ...
            <div className="Home-Content-Download-Details">
              <div className="Home-Content-Download-Details-Image">
                <img className="d-none d-sm-block" src={Images.image_home_mobile}/>
          ...
          <div className="d-flex Home-Body-Blog ">
            ...
            <p className="ml-auto">View all blog post <img src={Images.image_article_arrow_to_right}/></p>
          </div>
